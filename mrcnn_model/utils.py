...
def compute_ap_range(gt_box, gt_class_id, gt_mask,
    ...
    for iou_threshold in iou_thresholds:
        ...
        AP.append(ap)
    AP = np.array(AP).mean()
    #plt.legend(['iou_threshold 0.5','iou_threshold 0.55','iou_threshold 0.6','iou_threshold 0.65','iou_threshold 0.7','iou_threshold 0.75','iou_threshold 0.8','iou_threshold 0.85','iou_threshold 0.9','iou_threshold 0.95'],loc='best')
    if verbose:
